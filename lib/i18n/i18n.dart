...
class I18n {
  ...
  static const Map<String, Map<String, String?>> _localizations = {
    ...
    'ru': {
      ...
      'Are you sure you want to close this window?': 'Вы уверены, что хотите закрыть это окно?',
      ...
      'Created': 'Создано',
      'Modified': 'Изменено',
      'Delete temp cache': 'Удалить временный кэш',
      'Remember info': 'Запоминать информацию',
      'Switch to overlay': 'Переключить на компактный режим',
      'Switch to sidebar': 'Переключить на боковое меню',
      'Close window': 'Закрыть окно',
      'Theme': 'Тема',
      'Collapse': 'Свернуть',
      'Unpin window': 'Открепить окно',
      'Pin window': 'Закрепить окно',
      'Add new chat (Ctrl + T)': 'Создать новый чат (Ctrl + T)',
      'Clear conversation (Ctrl + R)': 'Очистить чат (Ctrl + R)',
      'Add to chat as SYSTEM': 'Добавить в чат как SYSTEM',
      'Add to chat as USER': 'Добавить в чат как USER',
      'Add to chat as {name}': 'Добавить в чат как {name}',
      'Send with waiting for response': 'Отправить с ожиданием ответа',
...
\${input} - выбранный текст''',
    ...
    'es': {
      ...
      'Are you sure you want to close this window?': '¿Estás seguro de querer cerrar esta ventana?',
      'Agent Mode: AI will plan and execute tasks autonomously using file operations and other tools. Your system message will be ignored in order to use this mode':
      ...
      'Created': 'Creado',
      'Modified': 'Modificado',
      'Delete temp cache': 'Borrar caché temporal',
      'Remember info': 'Recordar información',
      'Switch to overlay': 'Cambiar a modo compacto',
      'Switch to sidebar': 'Cambiar a sidebar',
      'Close window': 'Cerrar ventana',
      'Theme': 'Tema',
      'Collapse': 'Colapsar',
      'Unpin window': 'Desfijar ventana',
      'Pin window': 'Fijar ventana',
      'Add new chat (Ctrl + T)': 'Nuevo chat (Ctrl + T)',
      'Clear conversation (Ctrl + R)': 'Limpiar conversación (Ctrl + R)',
      'Add to chat as SYSTEM': 'Agregar en chat como SYSTEM',
      'Add to chat as USER': 'Agregar en chat como USER',
      'Add to chat as {name}': 'Agregar en chat como {name}',
      'Send with waiting for response': 'Enviar con espera de respuesta',
