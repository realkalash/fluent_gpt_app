...
class EasyImageViewerAdvancedDialog extends StatefulWidget {
  ...
  const EasyImageViewerAdvancedDialog(
    this.imageProvider, {
    super.key,
    this.immersive = true,
    this.onPageChanged,
  ...
  @override
  State<EasyImageViewerAdvancedDialog> createState() =>
      _EasyImageViewerAdvancedDialogState();
}

class _EasyImageViewerAdvancedDialogState
    extends State<EasyImageViewerAdvancedDialog> {
