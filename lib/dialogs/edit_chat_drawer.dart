          ...
          children: [
              ...
              children: [
                ...
                SqueareIconButton(
                  onTap: () async {
                    ...
                    final newPrompt = await getFormattedSystemPrompt(basicPrompt: currentStrippedPrompt);
            ...
            mat.Material(
              ...
              child: ExtendedTextField(
                ...
                minLines: 3,
                extendedContextMenuBuilder: ContextMenuBuilders.spellCheckContextMenuBuilder,
                extendedSpellCheckConfiguration: CustomSpellCheckService.getExtendedSpellCheckConfiguration(
                  chatProvider.spellCheck,
                ),
                onChanged: (value) {
                  debouncer.run(() {
                    countTokens();
            ...
            _GridChildRow(
              ...
              second: Tooltip(
                message: "The seed for the random number generator used in text generation. Use -1 or empty for random",
                child: Column(
                  children: [
                    const Text('Seed'),
                    TextBox(
